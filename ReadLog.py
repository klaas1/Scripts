...
folder = fixfolder( r'P:\18S FitFiles\Histograms' )#folder with chromosome sequence files (note, do not put other files in this folder)
...
folder = fixfolder( r'P:\18S FitFiles\wt_Regensburg_2016') #folder with chromosome sequence files (note, do not put other files in this folder)
filenames = os.listdir(folder)
os.chdir( folder )
wt_Reg2016_nuc=count_nuc(folder)
plt.hist(wt_Reg2016_nuc[0],  bins = 26, range = [0,25], alpha=0.5 )
Legend.append('wt_Reg_2016')
...
plt.legend(loc='best')
plt.show()
plt.savefig(newpath+r'\\'+'Wt_dUAF.pdf', format='pdf')
